...
$xtSettingsJson = Get-Content "$PSScriptRoot\5-DegeaAccess\crossTenantSettings.json"
...
$groupSettings = Get-Content "$PSScriptRoot\5-DegeaAccess\GroupSettings.json" | ConvertFrom-Json
